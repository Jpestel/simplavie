      ...
      <div className="max-w-2xl mx-auto px-4 h-12 flex items-center">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Feuille / cœur stylisé */}
            <path
              d="M14 7C14 7 8 10.5 8 15C8 18.3 10.7 21 14 21C17.3 21 20 18.3 20 15C20 10.5 14 7 14 7Z"
              fill="white"
              fillOpacity="0.95"
            />
            <path
              d="M14 11C14 11 11 13 11 15.5C11 17.2 12.3 18.5 14 18.5C15.7 18.5 17 17.2 17 15.5C17 13 14 11 14 11Z"
              fill="url(#gradient)"
              fillOpacity="0.6"
            />
            <defs>
